  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user) {
      toast({
        ...
        description: 'Please log in to place a booking',
        variant: 'destructive',
      });
      navigate('/login');
      return;
    ...
    try {
      const { error } = await supabase.from('bookings').insert([{
        ...
        city: city.trim(),
        street: street.trim(),
        special_notes: note.trim() || null,
        total_charge: calculateTotal(),
      ...
      toast({
        title: 'Success!',
        description: 'Your booking has been placed successfully. You will receive a confirmation email shortly.',
      });
      ...
      toast({
        title: 'Error',
        description: error.message || 'Failed to place booking. Please try again.',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
